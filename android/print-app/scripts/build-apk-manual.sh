...
perl -0pi -e 's/<manifest xmlns:android="http:\/\/schemas\.android\.com\/apk\/res\/android">/<manifest xmlns:android="http:\/\/schemas.android.com\/apk\/res\/android" package="com.miniprint">/' build/manual/AndroidManifest.xml
