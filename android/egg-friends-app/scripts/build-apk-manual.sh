...
KEYSTORE="${EGG_FRIENDS_KEYSTORE:-/private/tmp/egg-friends-debug.keystore}"
...
perl -0pi -e 's/<manifest xmlns:android="http:\/\/schemas\.android\.com\/apk\/res\/android">/<manifest xmlns:android="http:\/\/schemas.android.com\/apk\/res\/android" package="com.eggfriends">/' build/manual/AndroidManifest.xml
