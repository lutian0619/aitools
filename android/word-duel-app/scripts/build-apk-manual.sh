...
KEYSTORE="${WORD_DUEL_KEYSTORE:-/private/tmp/word-duel-debug.keystore}"
...
perl -0pi -e 's/<manifest xmlns:android="http:\/\/schemas\.android\.com\/apk\/res\/android">/<manifest xmlns:android="http:\/\/schemas.android.com\/apk\/res\/android" package="com.miniwordduel">/' build/manual/AndroidManifest.xml
