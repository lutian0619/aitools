...
KEYSTORE="${TRACKER_KEYSTORE:-/private/tmp/tracker-debug.keystore}"
...
perl -0pi -e 's/<manifest xmlns:android="http:\/\/schemas\.android\.com\/apk\/res\/android">/<manifest xmlns:android="http:\/\/schemas.android.com\/apk\/res\/android" package="com.minitracker">/' build/manual/AndroidManifest.xml
