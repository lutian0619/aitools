...
KEYSTORE="${STREET_DUEL_KEYSTORE:-/private/tmp/street-duel-debug.keystore}"
...
perl -0pi -e 's/<manifest xmlns:android="http:\/\/schemas\.android\.com\/apk\/res\/android">/<manifest xmlns:android="http:\/\/schemas.android.com\/apk\/res\/android" package="com.streetduel">/' build/manual/AndroidManifest.xml
